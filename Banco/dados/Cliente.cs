...
public class Cliente
{
    ...
    /// <summary>
    /// Pede os dados cadastrais do cliente para a base de dados
    /// </summary>
        ...
        do
        {
            ...
            if (cpfvalido == true)
            {
                ...
                if (Arquivo.Length == 0)
                {
                    ...
                    ex.ActiveWorkbook.SaveAs(@"C:\Users\43692939876\Desktop\Projetos\Encapsulamento\Banco\dados\Cliente.csv"); //sem o caminho, ele salva por default nos "MEUS DOCUMENTOS"
                    ex.Quit();
                    ex.Dispose();
                }
